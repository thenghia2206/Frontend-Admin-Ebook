...
import { DeleteOutlined, EditOutlined, EyeOutlined, PlusOutlined, StopOutlined } from "@ant-design/icons";
import { Form, Input, Select, Upload , Button} from "antd";
import { IUser ,
    IGetUsersRequest,
} from "../../common/user.interface";
import { blockUsersRequest, getUserRequest, getUsersStatisticRequest,
    ...
    },
    {
        ...
        <Space size="middle" style={{ display : 'flex' , justifyContent : 'center'}}>
            <Tooltip placement="top" title={"Chặn"}>
                <EditOutlined onClick={() => handleBlockUser(record)} />
            </Tooltip>
        </Space>
        ),
    },
  ...
  return (
    ...
    >
      ...
      <div className="table-area">
        <CTable
          tableMainTitle="Danh sách người dùng hoạt động"
