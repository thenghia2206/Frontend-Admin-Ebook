...
import { editAuthorRequest, editBookRequest, editCategoryRequest, editPublisherRequest, getAuthorRequest, getCategoryRequest, getPublisherRequest } from "../../redux/controller";
...
const CModalEditPublisher = (props: MyProps) => {
    ...
    const handleEdit = () => {
        ...
        dispatch(editPublisherRequest(bodyRequest));
...
export default CModalEditPublisher;
